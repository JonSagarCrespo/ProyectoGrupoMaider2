    ...
    public partial class formularioPrincipal : Form
    {
        ...
        private void menUsuarios_Click(object sender, EventArgs e)
        {
            /* FormularioUsuario form = new FormularioUsuario(); // creamos una instancia del formularioUsuario //
              form.controladorUsuario = this.controladorPricipal; //Se pasa el controlador principal al formulario Usuario para que ambos trabajen con la misma lógica y datos.
